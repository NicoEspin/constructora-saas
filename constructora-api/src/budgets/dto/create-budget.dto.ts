...
export class CreateBudgetDto {
  @ApiProperty({ example: 'Presupuesto refaccion cocina', description: 'Budget name' })
  @IsString()
  @MaxLength(160)
  name!: string;

  @ApiProperty({ example: 'client-id', description: 'Tenant-scoped client id' })
  @IsUUID()
  clientId!: string;
  ...
  @ApiPropertyOptional({ type: [CreateBudgetItemDto], description: 'Budget items' })
  @IsOptional()
  @IsArray()
